...
batchsize = 2
task = "segmentation"
dataset_name = "/data1/wzb/dataset/polyp/polyp_dataset/traindata_size100"
...
resume_checkpoint="/data1/wzb/hardsamply/contorl-lorav3/checkpoint/lora/checkpoint-5000"

feedback = "use"  # "no" or "use"
# repo_id = f"""sd-control-lora-v3-{task}-{half_or_full_lora}-rank{rank * 2 if "pissa" in init_lora_weights else rank}-{extra_suffix}"""

repo_id = f"""segformer_a_0.01"""

cmd = f"""\

CUDA_VISIBLE_DEVICES=4,5,6,7 \
nohup accelerate launch --main_process_port=8888  train_feedback.py \
 ...
 --output_dir="/data1/wzb/hardsamply/feedback/control_lora_ck/{repo_id}" \
