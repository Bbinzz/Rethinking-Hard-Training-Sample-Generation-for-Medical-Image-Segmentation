...
import json
# 数据集路径设置
META_DATA_PATH = "/data1/wzb/dataset/polyp/polyp_dataset/traindata_size100/traindata.json"
IMAGE_DIR = "/data1/wzb/dataset/polyp/polyp_dataset/traindata_size100"
CONDITION_IMAGE_DIR = "/data1/wzb/dataset/polyp/polyp_dataset/traindata_size100"
...
# 定义数据集
class Ployp(datasets.GeneratorBasedBuilder):
