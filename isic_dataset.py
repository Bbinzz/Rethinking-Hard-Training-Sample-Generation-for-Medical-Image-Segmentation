...
import json
# 数据集路径设置
META_DATA_PATH = "/data1/wzb/dataset/ISIB2016/train/traindata.json"
IMAGE_DIR = "/data1/wzb/dataset/ISIB2016/train"
CONDITION_IMAGE_DIR = "/data1/wzb/dataset/ISIB2016/train"
...
# 定义数据集
class ISIC(datasets.GeneratorBasedBuilder):
