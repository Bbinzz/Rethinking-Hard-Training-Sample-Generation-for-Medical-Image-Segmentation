...
import json
# 数据集路径设置
META_DATA_PATH = "/data1/wzb/dataset/Tumar_CT/train/traindata.json"
IMAGE_DIR = "/data1/wzb/dataset/Tumar_CT/train"
CONDITION_IMAGE_DIR = "/data1/wzb/dataset/Tumar_CT/train"
...
# 定义数据集
class Tumar_ct(datasets.GeneratorBasedBuilder):
